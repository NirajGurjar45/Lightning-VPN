package com.nirajgurjar.LightningVPN.Adapter;
...
import com.nirajgurjar.LightningVPN.MyApplication;
import com.nirajgurjar.LightningVPN.R;
        ...
        if (country.getCountry() != null && !country.getCountry().equals("")) {
            ...
            if (Prefs.getBoolean("appFailure", false)){
                ...
                if (country.getCountry().equals("ca")
                        ...
                        ||country.getCountry().equals("de")
                        ||country.getCountry().equals("no")
                        ||country.getCountry().equals("hk")
                        ||country.getCountry().equals("ru")
                        ||country.getCountry().equals("jp")
                        ||country.getCountry().equals("dk")
                        ||country.getCountry().equals("ua")
                        ||country.getCountry().equals("fr")
                        ||country.getCountry().equals("br")
                        ||country.getCountry().equals("se")
                        ||country.getCountry().equals("ie")
                        ||country.getCountry().equals("ch")
                        ||country.getCountry().equals("it")
                        ||country.getCountry().equals("mx")
                        ||country.getCountry().equals("es")
                        ||country.getCountry().equals("ar")
                        ||country.getCountry().equals("au")
                        ||country.getCountry().equals("cz")
                        ||country.getCountry().equals("ro")
                        ||country.getCountry().equals("tr")
                        ||country.getCountry().equals("nl")){
